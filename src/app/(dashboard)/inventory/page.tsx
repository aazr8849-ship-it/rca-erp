    ...
    <div>
      ...
      <Dialog open={!!freezeTarget} onOpenChange={(o) => !o && setFreezeTarget(null)}>
        <DialogContent>
          ...
          <DialogFooter><Button variant="outline" onClick={() => setFreezeTarget(null)}>取消</Button><Button onClick={handleFreezeSubmit} className="bg-[#2E8BFF] hover:bg-[#0B4BB8]">确认</Button></DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={!!adjustTarget} onOpenChange={(o) => !o && setAdjustTarget(null)}>
        <DialogContent>
          ...
          <DialogFooter><Button variant="outline" onClick={() => setAdjustTarget(null)}>取消</Button><Button onClick={handleAdjustSubmit} className="bg-[#2E8BFF] hover:bg-[#0B4BB8]">确认调整</Button></DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
  );
